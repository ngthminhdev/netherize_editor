...
This project is indexed by GitNexus as **netherize_editor** (7312 symbols, 19404 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
