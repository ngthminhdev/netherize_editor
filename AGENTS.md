...
This project is indexed by GitNexus as **netherize_editor** (6023 symbols, 15862 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the App_state area (400 symbols) | `.claude/skills/generated/app-state/SKILL.md` |
| Work in the Event_loop area (260 symbols) | `.claude/skills/generated/event-loop/SKILL.md` |
| Work in the Terminal area (145 symbols) | `.claude/skills/generated/terminal/SKILL.md` |
| Work in the Command_dispatch area (125 symbols) | `.claude/skills/generated/command-dispatch/SKILL.md` |
| Work in the Workbench area (114 symbols) | `.claude/skills/generated/workbench/SKILL.md` |
...
| Work in the Syntax area (97 symbols) | `.claude/skills/generated/syntax/SKILL.md` |
| Work in the Renderer area (95 symbols) | `.claude/skills/generated/renderer/SKILL.md` |
| Work in the Scheduler area (81 symbols) | `.claude/skills/generated/scheduler/SKILL.md` |
| Work in the Input_map area (80 symbols) | `.claude/skills/generated/input-map/SKILL.md` |
| Work in the Workspace area (66 symbols) | `.claude/skills/generated/workspace/SKILL.md` |
| Work in the Theme_config area (57 symbols) | `.claude/skills/generated/theme-config/SKILL.md` |
| Work in the Config area (44 symbols) | `.claude/skills/generated/config/SKILL.md` |
| Work in the Text area (43 symbols) | `.claude/skills/generated/text/SKILL.md` |
...
| Work in the Editor area (25 symbols) | `.claude/skills/generated/editor/SKILL.md` |
