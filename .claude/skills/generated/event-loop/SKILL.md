---
name: event-loop
description: "Skill for the Event_loop area of netherize_editor. 263 symbols across 41 files."
---

# Event_loop

263 symbols | 41 files | Cohesion: 76%
...
| File | Symbols |
|------|---------|
| `src/app/event_loop/setup.rs` | startup_subsystems, submit, submit_workspace_git_status_refresh, submit_active_buffer_git_baseline_refresh, flush_lsp_retry_if_due (+43) |
| `src/app/event_loop/helpers.rs` | region_color, byte_inside_any_span, rainbow_bracket_spans, render_markdown_node, render_children (+28) |
...
| `src/app/event_loop/commands.rs` | dismiss_system_dep_guide, accept_system_dep_guide, clear_expired_transient_toast, handle_command, dispatch_command_with_focused_terminal (+14) |
...
- **`region_color`** (Function) — `src/app/event_loop/helpers.rs:1303`
