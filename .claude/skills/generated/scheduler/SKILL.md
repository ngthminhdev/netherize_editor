---
name: scheduler
description: "Skill for the Scheduler area of netherize_editor. 83 symbols across 22 files."
---

# Scheduler

83 symbols | 22 files | Cohesion: 82%
...
| File | Symbols |
|------|---------|
| `src/async_runtime/scheduler/lsp_parse.rs` | lsp_request_response, parse_hover_content, parse_completion_items, parse_locations, parse_text_edits (+17) |
...
| `run_local_history_request` | Function | `src/async_runtime/scheduler/local_history.rs` | 26 |
...
| `dispatch_loop` | Function | `src/async_runtime/scheduler/dispatch.rs` | 60 |
