---
name: editor
description: "Skill for the Editor area of netherize_editor. 22 symbols across 8 files."
---

# Editor

22 symbols | 8 files | Cohesion: 49%
...
- **`current_overlays`** (Function) — `src/app/app_state/state.rs:746`
- **`completion`** (Function) — `src/app/app_state/state.rs:750`
...
| `blend_rgba` | Function | `src/render/renderer/editor/overlays.rs` | 900 |
| `strip_markdown_inline` | Function | `src/render/renderer/editor/overlays.rs` | 911 |
