...
| File | Symbols |
|------|---------|
| `src/text/text_system.rs` | set_font_family, set_text, rasterize_cache_key, collect_visible_glyphs, unbounded_height_shapes_deep_lines (+11) |
...
| `iter_visible_cells` | Function | `src/terminal/grid.rs` | 767 |
