...
use crate::{
    ...
    render::{
        ...
        renderer::{
            Renderer, SidebarRow, StatusbarLayoutKey, TopbarLayoutKey, TopbarTab, TopbarTabKind,
        },
    },
...
impl Renderer {
    ...
    pub fn update_buffer_terminal_content(
        ...
        let bg_quad = crate::render::region_pipeline::RegionDrawInstance::new(
            bounds,
            terminal_bg_color,
        );
        ...
        self.buffer_terminal_scissor =
            super::helpers::rect_to_scissor(bounds);
        ...
        if grid.used_rows() == 0 {
            ...
            self.buffer_terminal_glyph_instances = self
            ...
            if cell_x < clip_right {
                ...
                let (x, y, w, h, alpha) = match cursor_shape {
                    ...
                    crate::config::ui_config::CursorShape::Underline => {
                        let uh = cursor_underline_height.max(1.0);
                        (
                            cell_x,
                            cell_y + (cell_h - uh).max(0.0),
                            cell_w.max(1.0),
                            uh,
                            1.0,
                        )
                ...
                self.buffer_terminal_cursor_instances.push(
                    crate::render::region_pipeline::RegionDrawInstance::new(
                        [x, y, w, h],
