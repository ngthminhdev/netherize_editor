...
pub(in crate::config::theme_config) struct RawUi {
    ...
    pub(in crate::config::theme_config) fg_faint: Option<String>,
...
pub(in crate::config::theme_config) struct RawSyntax {
    ...
    pub(in crate::config::theme_config) constant: String,
    pub(in crate::config::theme_config) operator: String,
    pub(in crate::config::theme_config) variable: String,
